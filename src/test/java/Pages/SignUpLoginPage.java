...
public class SignUpLoginPage {
    ...
    public void createAccount(String password) {
        // Enter account information (gender and password)
        driver.findElement(maleGender_rbtn).click(); // Select male gender radio button
        driver.findElement(password_textBox).sendKeys(password); // Enter password
    ...
    public void assertRegistrationSuccess() {
        ...
        // Check if the message text equals "Account Created!" using soft assertion
    ...
    public void assertEmailExistsError() {
        ...
        // Check if the error message text equals "Email Address already exist!"
    ...
    public void assertWrongCredentials () {
        ...
        // Check if the error message text equals "Your email or password is incorrect!"
